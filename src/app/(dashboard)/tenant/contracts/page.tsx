...
export default async function TenantContractPage() {
  ...
  return (
    <div className="p-6 space-y-6 text-white">
      ...
      {!contract ? (
        <div className="rounded-2xl border border-zinc-800 bg-[#131626] p-8 text-center text-zinc-500">
        ...
        <>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div className="rounded-2xl border border-zinc-800 bg-[#131626] p-5">
              ...
              <p className="text-sm text-zinc-400">ថ្ងៃបង់ប្រាក់</p>
              <p className="text-2xl font-bold mt-1">
            ...
            <div className="rounded-2xl border border-zinc-800 bg-[#131626] p-5">
              ...
              <p className="text-sm text-zinc-400">ស្ថានភាព</p>
              <div className="mt-2">
          ...
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
            ...
            <div className="rounded-2xl border border-zinc-800 bg-[#131626] p-5">
              ...
              {/* {room?.images?.[0] ? (
                ...
                <div className="h-44 rounded-xl border border-zinc-800 bg-[#0b0d19] flex items-center justify-center text-sm text-zinc-600 mb-4">
                  No Room Image
                </div>
              )} */}
            ...
            <div className="rounded-2xl border border-zinc-800 bg-[#131626] p-5">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between text-sm">
                  <span className="text-zinc-500">ថ្ងៃចាប់ផ្តើម</span>
                  <span className="text-zinc-100">{contract.start_date}</span>
                </div>
                ...
                <div className="flex items-center justify-between text-sm">
                  <span className="text-zinc-500">ថ្ងៃបញ្ចប់</span>
                  <span className="text-zinc-100">{contract.end_date}</span>
                </div>
            ...
            <div className="rounded-2xl border border-zinc-800 bg-[#131626] p-5">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="rounded-xl border border-zinc-800 bg-[#0b0d19] p-4">
                  <p className="text-xs text-zinc-500">ថ្លៃបន្ទប់ប្រចាំខែ</p>
                ...
                <div className="rounded-xl border border-zinc-800 bg-[#0b0d19] p-4">
                  <p className="text-xs text-zinc-500">ប្រាក់កក់</p>
                ...
                <div className="rounded-xl border border-zinc-800 bg-[#0b0d19] p-4">
                  <p className="text-xs text-zinc-500">ថ្ងៃបង់ប្រាក់</p>
                ...
                <div className="rounded-xl border border-zinc-800 bg-[#0b0d19] p-4">
                  <p className="text-xs text-zinc-500">ស្ថានភាព</p>
                  <div className="mt-2">
                    <StatusBadge status={contract.status} />
                  </div>
                </div>
